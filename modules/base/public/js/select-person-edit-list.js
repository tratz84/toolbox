...
$(window).on('form-actions-set', function() {
	...
	if ($('.base-form-select-person-list-edit').length == 0) {
		return;
	}
	...
	$('.base-form-select-person-list-edit .add-entry-container.action-box').append('<span><a class="select-person" href="javascript:void(0);">'+_('Select person')+'</a></span>');
