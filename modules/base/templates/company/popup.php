...
<div class="page-header">
	...
	<div class="toolbox">
		<a href="<?= appUrl('/?m=base&c=comapny&a=edit') ?>" onclick="$('#company-table-container [name=lastname]').focus();" class="fa fa-plus" target="_blank"></a>
...
it_company.setConnectorUrl( '/?m=base&c=company&a=search' );
