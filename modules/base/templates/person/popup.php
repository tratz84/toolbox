...
<div class="page-header">
	...
	<div class="toolbox">
		<a href="<?= appUrl('/?m=base&c=person&a=edit') ?>" onclick="$('#person-table-container [name=lastname]').focus();" class="fa fa-plus" target="_blank"></a>
...
it_person.setConnectorUrl( '/?m=base&c=person&a=search' );
