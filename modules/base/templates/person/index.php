...
t.setRowClick(function(row, evt) {
	window.location = appUrl('/?m=base&c=person&a=edit&person_id=' + $(row).data('record').person_id);
});
...
t.addColumn({
	...
	render: function( record ) {
		...
		anchEdit.attr('href', appUrl('/?m=base&c=person&a=edit&person_id=' + person_id));
		
		var anchDel  = $('<a class="fa fa-trash" />');
		anchDel.attr('href', appUrl('/?m=base&c=person&a=delete&person_id=' + person_id));
