...
class ProjectService extends ServiceBase {
    ...
    public function searchHour($start, $limit, $opts = array()) {
        ...
        $r = ListResponse::fillByCursor($start, $limit, $cursor, array('project_hour_id', 'project_id', 'project_name', 'short_description', 'start_time', 'end_time', 'duration', 'total_minutes', 'declarable', 'user_id', 'username', 'company_name', 'firstname', 'insert_lastname', 'lastname', 'status_description', 'created'));
