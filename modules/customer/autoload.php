...
hook_register_javascript('mod-customer-script',  '/?mpf=/module/customer/js/script.js');
hook_htmlscriptloader_enableGroup('mod-customer-script');

hook_register_javascript('select-person-list-edit',  '/?mpf=/module/customer/js/select-person-edit-list.js');
hook_register_javascript('select-company-list-edit', '/?mpf=/module/customer/js/select-company-edit-list.js');
hook_register_javascript('customer-select-widget',   '/?mpf=/module/customer/js/customer-select-widget.js');
