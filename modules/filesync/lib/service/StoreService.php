...
class StoreService extends ServiceBase {
    ...
    public function searchFile($start, $limit, $opts) {
        ...
        $r = ListResponse::fillByCursor($start, $limit, $cursor, array('store_id', 'rev', 'store_name', 'company_id', 'company_name', 'firstname', 'insert_lastname', 'lastname', 'document_date', 'edited', 'created', 'subject', 'document_date', 'long_description', 'filesize', 'store_file_id', 'path', 'deleted', 'encrypted', 'lastmodified', 'public'));
